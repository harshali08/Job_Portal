                    ...
                    <table className="items-center bg-transparent w-full border-collapse">
                      ...
                      <tbody>
                        {currentUser.map((user, index) => (
                          <tr key={index}>
                            <td
                              className="border-t-0 px-2 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4 text-left text-blueGray-700 max-w-xs break-words sm:w-10"
                              style={{
                                width: "150px",
                                maxWidth: "150px",
                                wordWrap: "break-word",
                            ...
                            <td
                              className="border-t-0 px-2 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4 max-w-xs break-words sm:w-10"
                              style={{
                                width: "150px",
                                maxWidth: "150px",
                                wordWrap: "break-word",
                            ...
                            <td className="border-t-0 px-2 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4 max-w-xs break-words sm:w-10">
                              {user.email}
                            </td>
                          </tr>
                        ))}
