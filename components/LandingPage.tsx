    ...
    <div className=''>
      <div className='flex mt-10 md:flex-nowrap flex-wrap '>
        ...
        <div className='sm:w-1/2 sm:mx-2 sm:px-2 sm:ms-10 '>
            <h1 className=' text-gray-600 text-5xl lg:text-7xl font-bold sm:mt-20 sm:ms-10 ms-6 font-sans'>Your <span className='text-blue-700'>Job Search </span>Ends Here....</h1>
            <h3 className=' text-gray-800 text-md font-medium mt-3 sm:ms-10 ms-6'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.  since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</h3>
